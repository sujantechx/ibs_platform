...
class PuranPdf extends StatefulWidget {
  final String url; // URL of the PDF to display

  const PuranPdf({super.key, required this.url});

  @override
  _PuranPdfState createState() => _PuranPdfState();
}

class _PuranPdfState extends State<PuranPdf> {
