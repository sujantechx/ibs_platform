...
import 'package:ibs_platform/courses/ui/presentation/screens/Courses/public_course_grid_item.dart';

import '../../../../../core/routes/app_routes.dart';
import '../../../../../core/routes/course_routes.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () => context.go(AppRoutesCourses.login),
            ...
            itemBuilder: (context, index) {
              ...
              return PublicCourseGridItem(
                ...
                onTap: () {
                  ...
                  context.push(AppRoutesCourses.courseDetail, extra: course);
                },
              );
            },
          );
